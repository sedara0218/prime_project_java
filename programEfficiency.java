...
public class programEfficiency
{
	...
	public static void main(String[] args) throws Exception
	{
		int i;
		try {
			i = runProcess("javac primeCalcDemo.java");
			if (i != 0)
				System.exit(0);
			...
			i = runProcess("java primeCalcDemo 1");
			if (i != 0)
				System.exit(0);
			...
			i = runProcess("java primeCalcDemo 2");
			if (i != 0)
				System.exit(0);
			...
			i = runProcess("java primeCalcDemo 3");
			if (i != 0)
				System.exit(0);
			...
			i = runProcess("java primeCalcDemo 4");
			if (i != 0)
				System.exit(0);
			...
			i = runProcess("java primeCalcDemo 5");
			if (i != 0)
				System.exit(0);
			...
			i = runProcess("java primeCalcDemo 6");
			if (i != 0)
				System.exit(0);
			...
			i = runProcess("java primeCalcDemo 7");
			if (i != 0)
				System.exit(0);
			...
			i = runProcess("java primeCalcDemo 8");
			if (i != 0)
				System.exit(0);
			...
			i = runProcess("java primeCalcDemo 9");
			if (i != 0)
				System.exit(0);
			...
			i = runProcess("java primeCalcDemo 10");
			if (i != 0)
				System.exit(0);
			...
			i = runProcess("java primeCalcDemo 11");
			if (i != 0)
				System.exit(0);
			...
			i = runProcess("java primeCalcDemo 12");
			if (i != 0)
				System.exit(0);
			...
			i = runProcess("java primeCalcDemo 13");
			if (i != 0)
				System.exit(0);
